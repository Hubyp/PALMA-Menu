...
public class Menu {
    ...
    public Menu(Context context) {
        ...
        gdMenuBody.setStroke(55, Color.parseColor("#32cb00")); //Set border
        ...
        wView.loadData("<html>" +
                ...
                "<img src=\"" + IconWebViewData() + "\" width=\"25" + ICON_SIZE + "\" height=\"" + ICON_SIZE + "\" >" +
                "</body>" +
